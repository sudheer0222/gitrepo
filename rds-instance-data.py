...
def list_instances():
    ...
    columns_format="%-3s %-22s %-63s %-12s %-22s %-18s %-8s %-8s %-12s"
    print (columns_format % ("num", "Identifier", "Endpoint Address", "Class", "BackupRetentionPeriod", "Engine", "Version", "MultiAZ","Status"))
    num = 1
